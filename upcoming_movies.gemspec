...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ["'Sandesh Karki'"]
  spec.email         = ["'karkisandesh@hotmail.com'"]

  spec.summary       = %q{This is a upcoming movies exe files.}
  spec.description   = %q{This is a upcoming movies with their release dates, synopsis.}
